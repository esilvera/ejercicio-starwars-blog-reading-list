            ...
            <div className="row">
                ...
                <div className="col-6">
                    <ul className="nav nav-pills justify-content-center">
                        ...
                        <li className="nav-item">
                            <Link className={"nav-link" + (location.pathname === '/ships' ? " active" : "")} to="/ships">
                                Ships
                            </Link>
                        </li>
                        <li className="nav-item">
